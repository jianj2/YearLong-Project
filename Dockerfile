...
CMD ["serve","-s","build","-l","3000","--ssl-cert","letsencrypt/live/paediatricsssq.sytes.net/fullchain.pem","--ssl-key","letsencrypt/live/paediatricsssq.sytes.net/fullchain.pem"]
